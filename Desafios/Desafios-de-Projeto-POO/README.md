<h1> Desafio de Projeto Java - Bootcamp Dio</h1>

<p align="center"> </P>
<p><strong>APRENDENDO NA PRÁTICA O PARADIGMA DE ORIENTAÇÃO A OBJETOS</strong><br><br>Desafio implementado para a prática e aprendizagem durante a trilha do Bootcamp Potência Tech Powered Java Beginners do <strong><a href="https://www.ifood.com.br/">IFOOD :hearts: :hearts:</a></strong> juntamente com a plataforma de cursos online <strong><a href="https://web.digitalinnovation.one/">DIGITAL INNOVATION ONE</a></strong> 💛🧡 <br>
 
 💎 O objetivo principal desse desafio é colocar em prática umas das principais ferramentas da OO: <strong>ABSTRAÇÃO, ENCAPSULAMENTO, HERANÇA E POLIMORFISMO</strong></p>
...
<strong>	2.</strong> Criar as CLASSES: Bootcamp, Cursos, Mentorias e Devs, relacionando-as <br>
<strong>	3.</strong> As CLASSES Curso, Mentoria e Devs são MODELADOS, criação dos seus ATRIBUTOS E MÉTODOS <br> 
<strong>	4.</strong> Utilizar algumas ferramentas do PARADIGMA DE ORIENTAÇÃO A OBJETOS (POO): ABSTRAÇÃO, ENCAPSULAMENTO, HERANÇA E POLIMORFISMO <br>
